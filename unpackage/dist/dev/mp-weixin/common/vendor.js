...
// 创建视频相册
var museumVideoList = function museumVideoList(e) {
  return uniCloud.
  callFunction({
...
// 创建照片相册
var museumImgList = function museumImgList(e) {
  return uniCloud.
  callFunction({
    name: 'museumImgList',
    data: {
...
// 查询相册
var getMuseumImgList = function getMuseumImgList(e) {
  return uniCloud.
  callFunction({
